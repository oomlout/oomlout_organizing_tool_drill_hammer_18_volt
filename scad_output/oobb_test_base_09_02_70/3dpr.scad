			...
			rotate(a = [180, 0, 0]) {
				difference() {
					union() {
						...
						translate(v = [60.0000000000, 7.5000000000, -61.0000000000]) {
							cylinder(h = 61, r = 7.0000000000);
						}
						translate(v = [-60.0000000000, -7.5000000000, -61.0000000000]) {
							cylinder(h = 61, r = 7.0000000000);
						}
						translate(v = [60.0000000000, 7.5000000000, -66.0000000000]) {
					...
					union() {
						...
						translate(v = [60.0000000000, 7.5000000000, -61]) {
							rotate(a = [0, 0, 0]) {
								difference() {
									union() {
										#translate(v = [-1.8000000000, -3.0000000000, -5.3000000000]) {
